...
<Note variant="info">
  Welcome, contributors! This public playbook keeps humans and language models aligned on how to
  plan, draft, and review new HagenKit articles. Reference it whenever you brief an LLM or open a
  pull request.
</Note>
