...
export function WelcomeEmail({ firstName, dashboardUrl }: WelcomeEmailData) {
  ...
  return (
    ...
    >
      <Text style={paragraphStyle}>Thanks for signing up! We're excited to have you on board.</Text>
      <Text style={paragraphStyle}>
        {siteConfig.name} is your production-ready SaaS boilerplate with authentication, billing,
        and a complete design system. Everything you need to launch your next project is already set
        up and ready to go.
      </Text>
      <Text style={paragraphStyle}>
      ...
      <Text style={paragraphStyle}>
        If you have any questions or need assistance, our support team is here to help you every
        step of the way.
      </Text>
      <Text style={{ ...paragraphStyle, marginBottom: "4px" }}>Welcome aboard!</Text>
