...
export function PasswordReset({ firstName, resetUrl, expiresInMinutes }: PasswordResetData) {
  ...
  return (
    ...
    >
      ...
      <Text style={paragraphStyle}>
        We received a request to reset your password for your {siteConfig.name} account. Click the
      ...
      >
        ...
        <br />
        <a href={resetUrl} style={{ color: "#9B99FE", wordBreak: "break-all" }}>
          {resetUrl}
        </a>
      </Text>
    </EmailLayout>
