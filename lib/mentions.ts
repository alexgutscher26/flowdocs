...
export const SPECIAL_MENTIONS: MentionSuggestion[] = [
    { id: "here", display: "here", type: "special", metadata: { description: "Notify everyone currently online" } },
    { id: "channel", display: "channel", type: "special", metadata: { description: "Notify everyone in this channel" } },
];
