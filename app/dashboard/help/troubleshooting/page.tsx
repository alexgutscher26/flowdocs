...
export default function TroubleshootingPage() {
    return (
        ...
        >
            ...
            <ul>
                <li>Verify that you have the correct role for the action you are trying to perform (e.g., only Editors can edit documents).</li>
            ...
            <p>
                Email us at <a href="mailto:support@flowdocs.com" className="text-primary hover:underline">support@flowdocs.com</a> and we'll get back to you as soon as possible.
            </p>
        </HelpGuideLayout>
    );
}
