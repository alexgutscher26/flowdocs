...
export default function GettingStartedPage() {
  return (
    ...
    >
      ...
      <p>Workspaces are the home for your team's content. To create a new workspace:</p>
      <ol>
      ...
      <p>Collaboration is key in Flowdocs. Once you have a workspace, you can invite others:</p>
      <ul>
        <li>
          Navigate to <strong>Team</strong> in the sidebar.
        </li>
        <li>
      ...
      <p>Start capturing your knowledge by creating wiki pages:</p>
      <ol>
        <li>
          Go to the <strong>Wiki</strong> section.
        </li>
        <li>
        ...
        <li>
          Use slash commands (type <code>/</code>) to insert rich content like tables, images, and
          more.
        </li>
      </ol>
    </HelpGuideLayout>
