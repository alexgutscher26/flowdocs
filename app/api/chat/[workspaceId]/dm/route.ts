 ...
 * If all checks pass, it creates a new DM channel and returns the channel details.
 *
 * @param request - The NextRequest object containing the request data.
 * @param params - An object containing a promise that resolves to the workspace ID.
 * @returns The details of the newly created DM channel or an existing DM channel if found.
