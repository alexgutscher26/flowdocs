 ...
 *
 * This function retrieves the workspace ID from the request parameters and checks the user's session for authentication.
 * It verifies if the user is a member of the workspace and determines the visibility of channels based on the user's role.
 * Finally, it fetches the appropriate channels from the database and returns them in the response.
 *
