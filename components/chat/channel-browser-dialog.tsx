    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Discover and join public channels in this workspace</DialogDescription>
        </DialogHeader>
              ...
              {filteredChannels.map((channel) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isMember && (
                      <Button size="sm" onClick={() => handleJoin(channel.id)} disabled={isJoining}>
