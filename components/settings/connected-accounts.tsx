            ...
            {accounts.map((account) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="text-muted-foreground">{getProviderIcon(account.providerId)}</div>
                  <div>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>
                        Unlink {getProviderName(account.providerId)}?
                      </AlertDialogTitle>
                      <AlertDialogDescription>
                        You will no longer be able to sign in using{" "}
                        {getProviderName(account.providerId)}. Make sure you have another way to
                        access your account.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
