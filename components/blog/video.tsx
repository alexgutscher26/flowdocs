  ...
  if (videoData.platform === "direct") {
    return (
      <figure className="my-8">
        <div
          className={`relative ${aspectRatioClass} w-full overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800`}
        >
          <video
            src={src}
            controls
    ...
    <figure className="my-8">
      ...
      >
        {!isPlaying && videoData.thumbnailUrl ? (
          ...
          >
            <img src={videoData.thumbnailUrl} alt={title} className="h-full w-full object-cover" />
