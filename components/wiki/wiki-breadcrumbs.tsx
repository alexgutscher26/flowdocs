...
export function WikiBreadcrumbs({
    ...
    const breadcrumbs =
        tree && currentPageId ? findPath(tree, currentPageId) : [];
    ...
    const displayBreadcrumbs = breadcrumbs || (currentPageTitle ? [{ id: currentPageId!, title: currentPageTitle, slug: currentPageSlug!, parentId: null, children: [] }] : []);
